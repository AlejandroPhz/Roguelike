...
{
    public class WallCactus : AttackableCellObject
    {
        ...
        public override void Damaged(int amount)
        {
            ...
            {
                FMODUnity.RuntimeManager.PlayOneShot("event:/SFX/Interactables/Walls/Desert Wall Hit");

                GameManager.Instance.Board.SetCellTile(m_Cell, WallTileDamaged);
            }
            else if (m_CurrentHealth == 0)
            {
                FMODUnity.RuntimeManager.PlayOneShot("event:/SFX/Interactables/Walls/Desert Wall Destroy");
